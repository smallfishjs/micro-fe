...
// for prefetch
function getExternalStyleSheets (styles: string[]) {
...
// for prefetch
function getExternalScripts (scripts: string[]) {
...
function execScripts (scripts: string[], proxy = window) {
...
export function setGlobalExcludes (excludes: RegExp[]) {
